        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <section className="bg-card p-8 rounded-3xl border shadow-sm">
            ...
            <p className="text-xl leading-relaxed text-muted-foreground">
              نهدف في برنامج الرياضيات بمؤسسة الهدى التعليمية إلى تحويل مادة الرياضيات من عبء إلى متعة ذهنية، من خلال تبسيط المفاهيم المعقدة وربطها بالواقع العملي، مع التركيز على مهارات الحل السريع والتفكير الإبداعي.
            </p>
          </section>
