        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <section className="bg-card p-8 rounded-3xl border shadow-sm">
            ...
            <p className="text-xl leading-relaxed text-muted-foreground">
              نقدم في مؤسسة الهدى التعليمية برنامجاً متطوراً لتعليم اللغة الإنجليزية، يجمع بين القواعد الأساسية ومهارات التواصل الحيوي. نهدف إلى تمكين الطالب من التعبير عن نفسه بثقة واقتدار في مختلف المواقف الاجتماعية والأكاديمية.
            </p>
          </section>
